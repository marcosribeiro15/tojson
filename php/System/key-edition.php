...
class KeyEdition{
	...
	public function script_consulta($consulta){
		$edition="sed -e 's/\"ipv4-prefix\": \"172.18.0.2\/32\"/\"ipv4-prefix\": \"11.11.11.11/32\"/g' /var/www/html/tojson/models/consulta.json > /var/www/html/tojson/json/consulta.json 2>&1";
